...
`@script`
Recall from the previous chapters that we are working with a transactional dataset with 4 items, denoted as A, B, C and D to keep it easy. 
Remember that you are given a set of 7 transactions, all having a specific ID, the transaction ID. 
