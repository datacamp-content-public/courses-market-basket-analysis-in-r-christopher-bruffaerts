...
`@script`
By inspecting the object, we obtain a dataframe containing the frequent itemsets with their respective support and count. The output corresponds to the itemset lattice displayed on the right hand side of the slide which we built earlier.
