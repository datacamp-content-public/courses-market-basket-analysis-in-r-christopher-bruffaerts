...
`@script`
In this lesson, we are going to cover one of the algorithm behind the association rule mining, the apriori algorithm. On the one hand we are going to understand the rationale behind this algorithm and on the other hand see how to apply it with the arules package.
