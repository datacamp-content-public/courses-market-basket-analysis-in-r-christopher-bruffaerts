...
`@script`
To generate association rules and steer the output of the set of extracted rules, the arguments parameter, control and appearance can be used. Parameters contain values such as support, confidence threshold and minimum length of rules. Control allow to 
