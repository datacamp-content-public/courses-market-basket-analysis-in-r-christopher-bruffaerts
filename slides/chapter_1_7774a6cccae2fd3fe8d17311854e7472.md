...
`@script`
The apriori algorithm goes through the entire itemset lattice (starting from the 1-itemset), explores and counts all neighbour nodes at level 1, then moves to the 2-itemsets, and so forth.
