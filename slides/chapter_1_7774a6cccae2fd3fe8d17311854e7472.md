...
`@script`
Recall from the previous chapters that we are working with the supermarket data for illustration purposes. Suppose there are 4 items we are interested in: Bread, Butter, Cheese and Wine. To make it easier for the rest of the lesson, let us use the following abbreviations.
