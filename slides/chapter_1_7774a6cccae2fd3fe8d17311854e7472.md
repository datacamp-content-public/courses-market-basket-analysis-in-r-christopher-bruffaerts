...
`@script`
The apriori algorithm goes through the entire itemset lattice (starting from the 1-itemset), explores and counts all neighbour nodes at that level, then moves to the 2-itemsets, repeats the operation and so forth.
