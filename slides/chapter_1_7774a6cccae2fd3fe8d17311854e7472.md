...
`@script`
The final set of frequent itemsets, shown here in blue, is computationally intense.

After retrieving frequent itemsets, the apriori algorithm generates associated rules. It starts with rules containing a single precedent.

ADD EXAMPLE LOW CONFIDENCE
