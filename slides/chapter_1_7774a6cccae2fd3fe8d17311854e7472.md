...
We start by counting the number of occurences of A within the transactional dataset; in this case it appears 3 times. Similary, we scan the databset to obtain the support of items B, C and D.
